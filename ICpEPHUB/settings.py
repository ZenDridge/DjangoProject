...
MIDDLEWARE = [
    ...
    'django.contrib.auth.middleware.AuthenticationMiddleware',  # Ensure this comes before your custom middleware
    'myapp.middleware.SetupMiddleware',  # Custom middleware
